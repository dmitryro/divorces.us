...
import Spousal from "components/Spousal/index.tsx";

function SpousalSupportPage(props) {
  useEffect(() =>  {
  });
...
export default withStyles(componentsStyle)(observer(SpousalSupportPage));
