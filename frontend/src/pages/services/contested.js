...
import Contested from "components/Contested/index.tsx"

function ContestedDivorce(props) {
  useEffect(() =>  {
  });
...
export default withStyles(componentsStyle)(observer(ContestedDivorce));
