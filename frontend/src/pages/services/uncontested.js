...
import Uncontested from "components/Uncontested/index.tsx"

function UncontestedDivorce(props) {
  useEffect(() =>  {
  });
...
export default withStyles(componentsStyle)(observer(UncontestedDivorce));
