...
import OnlineConsultation from "components/OnlineConsultation/index.tsx";

function OnlineConsultationPage(props) {
  useEffect(() =>  {
  });
  ...
  const { classes, ...rest } = props;
    ...
    return (
      <div>
        ...
        <div>OnlineConsultation a Question</div>
        <OnlineConsultation/>
        <Footer />
...
export default withStyles(componentsStyle)(observer(OnlineConsultationPage));
