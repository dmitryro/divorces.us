...
from gui.models import AskTemplate
...
from signup.callbacks import resend_activation_handler
from signup.signals import user_resend_activation
...
from .serializers import FrontBlockSerializer
from .serializers import CountrySerializer
from .serializers import AskTemplateSerializer
...
@permission_classes([AllowAny,])
@csrf_exempt
def GetSearchResultsView(request):
    """
     A view that returns incoming messages
    """
    try:
        ...
        #    res = chain(posts,categories)
            ...
            return Response({ 'posts': serializer_posts.data,
...
def pricing(request):
    ...
    if request.user.is_authenticated:
        ...
        try:
           ...
           log = Logger(log=f'WE GOT SOME ERROR {e}')
           log.save()
           user_id = -1
           username = ''
           first_name = ''
