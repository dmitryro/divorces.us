...
from users.models import StateProvince
...
class Address(models.Model):
    ...
    state_province = models.ForeignKey(StateProvince, related_name='state_province', 
...
class CreditCard(models.Model):
    ...
    owner = models.ForeignKey(Profile, blank=True,
    ...
    card_type = models.ForeignKey(CardType, blank=True,
                                  null=True, on_delete=models.CASCADE)
...
class Transaction(MerchantActivity):
    ...
    type = models.ForeignKey(TransactionType, blank=False,
                             null=True, on_delete=models.CASCADE)
    payment_method_used = models.ForeignKey(CreditCard, blank=True,
                                            null=True, on_delete=models.CASCADE)
    ...
    status = models.ForeignKey(TransactionStatus, blank=True,
                               null=True, on_delete=models.CASCADE)
...
class Payment(models.Model):
    payment = models.ForeignKey(CustomerPayment, blank=True,
                                null=True, on_delete=models.CASCADE) 
    first_name = models.CharField(max_length=100, blank=True, null=True)
    last_name = models.CharField(max_length=100, blank=True, null=True)
...
class CustomerProfile(models.Model):
    ...
    profile = models.OneToOneField(Profile, related_name='customer_profle',
                                   blank=True, null=True, on_delete=models.CASCADE)
    ...
    stats = models.OneToOneField(CustomerActivityStats,
                                 related_name='customer_activity_stats',
                                 blank=True, null=True, on_delete=models.CASCADE)
