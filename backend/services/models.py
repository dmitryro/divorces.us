...
class Package(models.Model):
   ...
   fees = models.FloatField(default=0, blank=True, null=True)
   price = models.FloatField(default=0, blank=True, null=True)
   package_type = models.ForeignKey(PackageType, blank=True, 
...
class PackageNote(models.Model):
    ...
    package = models.ForeignKey(Package, related_name='notes', blank=True, null=True, 
                                on_delete=models.CASCADE)
